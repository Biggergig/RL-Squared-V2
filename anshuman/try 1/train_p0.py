...
if __name__ == "__main__":
    ...
    CHECKPOINT_SAVE_FOLDER = "data/checkpoints/p0/ppo"
    try:
        CHECKPOINT_LOAD_DIR = "data/checkpoints/p0/" + str(
            max(os.listdir("data/checkpoints/p0/"), key=lambda d: int(d.split("-")[-1]))
        )
    ...
    learner = Learner(
        ...
        wandb_run_name="PPO-p0-" + str(int(time()) % 1_000_000),
        wandb_project_name="ans_phase0",
